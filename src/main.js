...
function renderExamples() {
  ...
  const differences = metricStateDifferences[state.selectedMetricId] || { atRest: "Data not available.", inDomain: "Data not available.", outOfDomain: "Data not available." };
...
function renderStateCarouselCard(title, items) {
  ...
  return `
    <div class="flex flex-col bg-[#FCFBFF] border border-[#E5E2EC] rounded-xl h-[420px] w-full shadow-sm overflow-hidden text-gray-800">
      <div class="p-8 border-b border-[#E5E2EC]/60 flex-shrink-0 bg-white/50 backdrop-blur-sm">
