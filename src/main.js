    ...
    <div class="relative min-h-screen z-10 flex justify-center">
      ...
      <div class="w-full max-w-6xl p-8 md:p-16">
        ...
        <header class="mb-12">
          ...
          <p class="text-center text-xl text-gray-600 max-w-2xl mx-auto mb-10" style="font-family: var(--font-content), serif">A cohesive walkthrough of metrics applied across distinct network states.</p>
